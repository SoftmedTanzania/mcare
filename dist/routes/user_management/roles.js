...
router.get('/role/type/update/:id', function (request, response) {
  ...
  var model = new _RolesModel.default();
  model.update("role_type", roleType, where).then(function (result) {
    var api = new _ApiResponse.default(result, null, true);
    response.json(JSON.stringify(api));
  }).catch(function (err) {
    var api = new _ApiResponse.default(null, err, false);
...
router.get('/role/type/delete/:id', function (request, response) {
  ...
  var model = new _RolesModel.default();
  model.delete("role_type", where).then(function (result) {
    var api = new _ApiResponse.default(result, null, true);
    response.json(JSON.stringify(api));
  }).catch(function (err) {
    var api = new _ApiResponse.default(null, err, false);
...
router.get('/role/type', function (request, response) {
  ...
  var model = new _RolesModel.default();
  model.read("role_type", where).then(function (result) {
    var api = new _ApiResponse.default(result, null, true);
    response.json(JSON.stringify(api));
  }).catch(function (err) {
    var api = new _ApiResponse.default(null, err, false);
...
router.get('/role/category/update/:id', function (request, response) {
  ...
  var model = new _RolesModel.default();
  model.update("role_type_category", roleTypeCategory, where).then(function (result) {
    var api = new _ApiResponse.default(result, null, true);
    response.json(JSON.stringify(api));
  }).catch(function (err) {
    var api = new _ApiResponse.default(null, err, false);
...
router.get('/role/category/delete/:id', function (request, response) {
  ...
  var model = new _RolesModel.default();
  model.deleteRecord("role_type_category", where).then(function (result) {
    var api = new _ApiResponse.default(result, null, true);
    response.json(JSON.stringify(api));
  }).catch(function (err) {
    var api = new _ApiResponse.default(null, err, false);
...
router.get('/role/category', function (request, response) {
  ...
  var model = new _RolesModel.default();
  model.read("role_type_category", where).then(function (result) {
    var api = new _ApiResponse.default(result, null, true);
    response.json(JSON.stringify(api));
  }).catch(function (err) {
    var api = new _ApiResponse.default(null, err, false);
...
router.get('/user/create', function (request, response) {
  var user = {
    UserId: null,
    DepartmentId: null,
    Surname: "john",
  ...
  var model = new _RolesModel.default();
  model.addUser(roleTypeCategory).then(function (result) {
    var api = new _ApiResponse.default(result, null, true);
    response.json(JSON.stringify(api));
  }).catch(function (err) {
    var api = new _ApiResponse.default(null, err, false);
